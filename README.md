...
[![byteman build](https://img.shields.io/badge/Build%20207-%E2%9C%94-green)](https://github.com/FPGA-Research-Manchester/byteman/commits/main)
...
## $> byteman.exe -help
```python
byteman 1.2 (Build #206, compiled on Jul 26 2022 18:56:05)
Usage:
...
Commands:        : [Description]                                    
  ...
  -c (Change)    : modify primitives.             see "-help change"
