...
[![byteman build](https://img.shields.io/badge/Build%20211-%E2%9C%94-green)](https://github.com/FPGA-Research-Manchester/byteman/commits/main)
...
## $> byteman.exe -help
```python
byteman 1.3 (Build #210, compiled on Jul 29 2022 11:55:23)
Usage:
...
byteman 1.3 (Build #210, compiled on Jul 29 2022 11:55:23)
  ...
  Examples:
    ...
    byteman.exe XUSP -input bitstream.bit -change bigEndian -output full bitstream.bit
