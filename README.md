...
[![byteman build](https://img.shields.io/badge/Build%20224-%E2%9C%94-green)](https://github.com/FPGA-Research-Manchester/byteman/commits/main)
...
## $> byteman.exe -help
```python
byteman 1.3 (Build #223, compiled on Sep 23 2022 14:40:54)
Usage:
...
A list of currently supported Xilinx Series 7 devices: 
  ...
  Series 7 Boards: 
    ...
    Arty S7-25, Arty S7-50, Basys 3, Pynq Z1, Pynq Z2, Nexys A7-50, Nexys A7-100, Zybo Z7-10, Zybo Z7-20, Cmod A7-15, 
...
A list of currently supported Xilinx UltraScale+ devices: 
  ...
  Misc UltraScale+ Boards: 
    ...
    ZUBoard 1CG, KCU 116, Vermeo T1 MPSoC, Vermeo T1 RFSoC, ZCU 1275, ZCU 1285, ZCU 111, PYNQ-ZU
```
