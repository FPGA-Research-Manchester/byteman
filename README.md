...
[![byteman build](https://img.shields.io/badge/Build%20215-%E2%9C%94-green)](https://github.com/FPGA-Research-Manchester/byteman/commits/main)
...
## $> byteman.exe -help
```python
byteman 1.3 (Build #214, compiled on Aug  2 2022 11:11:05)
Usage:
