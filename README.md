...
[![byteman build](https://img.shields.io/badge/Build%20218-%E2%9C%94-green)](https://github.com/FPGA-Research-Manchester/byteman/commits/main)
...
## $> byteman.exe -help
```python
byteman 1.3 (Build #218, compiled on Aug  4 2022 11:15:34)
Usage:
