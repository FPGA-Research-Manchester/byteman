...
[![byteman build](https://img.shields.io/badge/Build%20209-%E2%9C%94-green)](https://github.com/FPGA-Research-Manchester/byteman/commits/main)
...
## $> byteman.exe -help
```python
byteman 1.3 (Build #209, compiled on Jul 29 2022 11:48:46)
Usage:
