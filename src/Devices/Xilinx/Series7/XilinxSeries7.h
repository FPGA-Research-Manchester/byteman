...
class XilinxSeries7: virtual public CommonDevice2D, public XilinxConfigurationAccessPort<archXS7template>
{
	public:
		...
		std::streamoff slrMagicInstrLocation[XS7_MAX_SLRS];/// Written by outputBitstreamSLRHeaderAfterBitstreamSequence(), outputBitstreamEmptySLRHeaderSequence() and used by outputBitstreamSLRWrapUpSequence(), outputBitstreamEmptySLRWrapUpSequence()
