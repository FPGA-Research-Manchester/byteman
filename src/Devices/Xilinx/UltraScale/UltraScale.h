...
#ifndef XILINXULTRASCALE_H
#define XILINXULTRASCALE_H
...
class XilinxUltraScale: virtual public CommonDevice2D, public XilinxConfigurationAccessPort<archXUStemplate>
{
	public:
		XilinxUltraScale();
		...
		streamoff slrMagicInstrLocation[FABRIC_MAX_SLRS];/// Written by outputBitstreamSLRHeaderAfterBitstreamSequence(), outputBitstreamEmptySLRHeaderSequence() and used by outputBitstreamSLRWrapUpSequence(), outputBitstreamEmptySLRWrapUpSequence()
		...
		void merge(XilinxUltraScale*, string, Rect2D, Coord2D);
		...
		void setFabricChar(string, char, int, bool=false);
		void initFabric();
};

#endif // XILINXULTRASCALE_H
