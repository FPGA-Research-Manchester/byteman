...
#include "../XilinxConfigurationAccessPort.h"
	...
	#define archXUStemplate FABRIC_TEMPLATE(XUS_MAX_SLRS, XUS_MAX_ROWS, XUS_MAX_COLS, XUS_MAX_BRAM_COLS, XUS_BLOCKTYPE_LOGIC, XUS_BLOCKTYPE_BLOCKRAM,XUS_WORDS_BEFORE_CLK, XUS_WORDS_AT_CLK, XUS_WORDS_AFTER_CLK, XUS_WORDS_PER_FRAME,XUS_FRAMES_PER_BRAM_CONTENT_COLUMN, XUS_CLB_PER_CLOCK_REGION, XUS_BRAM_PER_CLOCK_REGION, XUS_EXTRA_FRAMES_PER_ROW, XUS_USESTOPBOTTOM, XUS_TOPBOTTOM_SHIFT, XUS_BLOCKTYPE_SHIFT, XUS_BLOCKTYPE_MASK, XUS_ROWADDRESS_SHIFT, XUS_ROWADDRESS_MASK, XUS_COLUMNADDRESS_SHIFT, XUS_COLUMNADDRESS_MASK, XUS_MINORADDRESS_SHIFT, XUS_MINORADDRESS_MASK)
