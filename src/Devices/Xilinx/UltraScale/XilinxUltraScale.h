...
class XilinxUltraScale: virtual public CommonDevice2D, public XilinxConfigurationAccessPort<archXUStemplate>
{
	public:
		...
		streamoff slrMagicInstrLocation[XUS_MAX_SLRS];/// Written by outputBitstreamSLRHeaderAfterBitstreamSequence(), outputBitstreamEmptySLRHeaderSequence() and used by outputBitstreamSLRWrapUpSequence(), outputBitstreamEmptySLRWrapUpSequence()
