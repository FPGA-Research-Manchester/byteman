...
#include "../XilinxConfigurationAccessPort.h"
	...
	#define archXUSPtemplate FABRIC_TEMPLATE(XUSP_MAX_SLRS, XUSP_MAX_ROWS, XUSP_MAX_COLS, XUSP_MAX_BRAM_COLS, XUSP_BLOCKTYPE_LOGIC, XUSP_BLOCKTYPE_BLOCKRAM,XUSP_WORDS_BEFORE_CLK, XUSP_WORDS_AT_CLK, XUSP_WORDS_AFTER_CLK, XUSP_WORDS_PER_FRAME,XUSP_FRAMES_PER_BRAM_CONTENT_COLUMN, XUSP_CLB_PER_CLOCK_REGION, XUSP_BRAM_PER_CLOCK_REGION, XUSP_EXTRA_FRAMES_PER_ROW, XUSP_USESTOPBOTTOM, XUSP_TOPBOTTOM_SHIFT, XUSP_BLOCKTYPE_SHIFT, XUSP_BLOCKTYPE_MASK, XUSP_ROWADDRESS_SHIFT, XUSP_ROWADDRESS_MASK, XUSP_COLUMNADDRESS_SHIFT, XUSP_COLUMNADDRESS_MASK, XUSP_MINORADDRESS_SHIFT, XUSP_MINORADDRESS_MASK)
