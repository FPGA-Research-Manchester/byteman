...
void XilinxUltraScalePlus::setDeviceByNameOrThrow(string name){
...
int XilinxUltraScalePlus::getDeviceByName(string name)
{
	...
	//Some boards for easier use
		...
		if(str::iff::stringContains(name, "genesyszu-5ev", "genesyszu5ev", "genesys-5ev", "genesys5ev"))
			return XUSP_DEVICE_GENESYS_5EV;
		if(str::iff::stringContains(name, "genesyszu-3eg", "genesyszu3eg", "genesys-3eg", "genesys3eg"))
			return XUSP_DEVICE_GENESYS_3EG;
	#endif
	return XUSP_DEVICE_NULL;
}
/************************************************************************** /**
...
void XilinxUltraScalePlus::setDevice(int deviceID, string customPartName)
{
	...
	switch(deviceID){
		...
		case XUSP_DEVICE_ZCU111:
			...
			break;
		case XUSP_DEVICE_GENESYS_5EV:
			XCZU5();
			setCustomPartName("xczu5ev-sfvc784-1-e");
			break;
		case XUSP_DEVICE_GENESYS_3EG:
			XCZU3();
			setCustomPartName("xczu3eg-sfvc784-1-e");
			break;
		#endif
